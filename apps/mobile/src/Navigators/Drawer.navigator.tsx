...
import ListPostmarioScreen from "../Entities/Postmario/List.postmario.screen";
import ShowPostmarioScreen from "../Entities/Postmario/Show.postmario.screen";
  ...
  return (
    <Stack.Navigator {...stackrops}>
      ...
      />
        ...
        <Stack.Screen
            name="ListPostmarioScreen"
            component={ListPostmarioScreen}
            options={screenOptions}
          />
          <Stack.Screen
          name="ShowPostmarioScreen"
          component={ShowPostmarioScreen}
          options={screenOptions}
        />
