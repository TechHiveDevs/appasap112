...
/**
 * import { Postmario } from "@prisma/client";
 * import { postmarioUseCase1Service } from "./postmario-services/postmarioUseCase1.service";
 */

// ----------------------------------------------------------------

const entity = `postmario`;
const path = `/postmario`;
